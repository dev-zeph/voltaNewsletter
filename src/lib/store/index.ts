...
/**
 * Bob's storage. One JSON file per collection under .data/.
 *
 * Deliberately boring: no DB to provision, works on localhost the moment you
 * clone the repo. Every read/write goes through this module, so swapping in
 * Postgres later is one file, not a refactor.
 */
